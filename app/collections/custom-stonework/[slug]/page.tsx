...
interface CustomStoneworkPageProps {
  params: Promise<{ slug: string }>;
}

export default function CustomStoneworkPage({ params }: CustomStoneworkPageProps) {
  ...
  const breadcrumbItems: BreadcrumbItem[] = [
    { label: 'Home', href: '/' },
    { label: 'Custom Stonework', href: '/collections/custom-stonework' },
    { label: title },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <CategoryHeader title={title} description={"Explore our custom stonework collection"} />
      <ProductActionsBar
