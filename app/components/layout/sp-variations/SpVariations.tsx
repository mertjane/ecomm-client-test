    ...
    <div className="flex flex-col mt-4 py-4">
      ...
      <div className=" w-full flex flex-col mt-4">
        ...
        <div className="flex px-4 pt-2">
          ...
          {isTilingProduct ? (
            <small className="flex-1 text-clay text-end">
              per m<sup>2</sup>
            </small>
          ) : (
        ...
        {sortedVariations.map((v) => {
          ...
          return (
            <div
              onClick={() => handleSelectedVariation(v)}
              key={v.id}
              className={cn(
            ...
            >
              <span className="flex-4 text-granite pl-4">
                {v.name}
              ...
              {isTilingProduct ? (
                <span className="flex-1 text-granite text-end">
                  £{piecePrice.toFixed(2)}
                </span>
              ) : (
                <></>
              )}
              <span className="flex-1 text-granite text-end mr-4">
      ...
      {isTilingProduct && (
        <>
          ...
          <CustomCutModal
            isOpen={showCustomCutForm}
            setIsOpen={setShowCustomCutForm}
          />
        </>
      )}
    </div>
